Create a single horizontal sprite strip for the Codex app digital pet `vera-clear` in the state `waving`.
...
Animation action: hand-to-mouth kiss gesture with forward blown kiss and wink.
...
- Show one hand moving to the mouth, then the hand extending forward as if blowing a kiss.
- Include a wink during the kiss release. Keep it playful and cute, not seductive.
- Use only hand pose, face expression, and tiny head movement. No hearts, sparkles, kiss marks, floating symbols, or detached effects.

State-specific requirements:
- Show the greeting through hand pose and face only: hand near mouth, wink, hand extended forward, then return.
- Do not draw hearts, lip marks, wave marks, motion arcs, lines, sparkles, symbols, or floating effects around the hand or mouth.
